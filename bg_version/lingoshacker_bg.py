...
for i in range(ilee):
    ...
    try:
        if driver.find_element(By.CSS_SELECTOR, 'h4.mb-0').size != 0:
            textBef = driver.find_element(By.CSS_SELECTOR, 'h3.mb-0').text
            dictionary.write(f"{driver.find_element(By.CSS_SELECTOR, 'h3.mb-3').text}\n")
        ...
        textBef = str(driver.find_element(By.CSS_SELECTOR, 'h3.mb-3').text + '\n')
